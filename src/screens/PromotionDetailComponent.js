          ...
          <View style={styles.opacity}>
            ...
            <View style={styles.companyData}>
              ...
              <Text style={styles.ratingCompany}>
                <Icon
                  iconStyle={{color: '#FFC700', fontSize: 10}}
                  name="star"
                />
                4.5
              </Text>
            ...
            <View style={styles.containerDescription}>
              ...
              <View style={styles.containerDescriptionText}>
                ...
                <Text style={{textAlign: 'justify'}}>
                  ...
                  in tempus nulla. Nam congue mauris at leo rutrum, quis
                  malesuada urna dignissim. Orci varius natoque penatibus et
                  magnis dis parturient montes, nascetur ridiculus mus. Nunc sit
                  amet urna mattis, condimentum odio ac, egestas sapien. Nam
                  venenatis nibh quam, sit amet sollicitudin sapien volutpat et.
                  Suspendisse a orci venenatis, laoreet odio varius, tincidunt
                </Text>
              </View>
